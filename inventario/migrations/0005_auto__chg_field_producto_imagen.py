...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventario_producto', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'producto.imagen'
        db.alter_column(u'inventario_producto', 'imagen', self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100))
