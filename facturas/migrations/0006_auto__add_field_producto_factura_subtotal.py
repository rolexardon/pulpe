...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'producto_factura.subtotal'
        db.add_column(u'facturas_producto_factura', 'subtotal',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'producto_factura.subtotal'
        db.delete_column(u'facturas_producto_factura', 'subtotal')
